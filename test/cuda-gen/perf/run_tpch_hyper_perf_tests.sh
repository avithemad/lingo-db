...
OUTPUT_FILE=$SCRIPT_DIR/tpch-hyper-perf.csv
...
for QUERY in "${QUERIES[@]}"; do
  ...
  COMPILE_SQL="$BUILD_DIR/run-sql $TPCH_DIR/$QUERY.sql $TPCH_DATA_DIR --gen-cuda-code --gen-kernel-timing"
  echo $COMPILE_SQL
  $COMPILE_SQL
