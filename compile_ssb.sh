...
do
    ...
    build/lingodb-debug/mlir-db-opt --use-db resources/data/ssb-1 --gen-cuda-code --ssb --relalg-query-opt intermediate_mlir/ssb_q$i.mlir  > intermediate_mlir/ssb_q$i.optimized.new.mlir
    if [ $? -eq 0 ]; then 
        echo "Copying..."
